{{-- <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
      <a class="navbar-brand brand-logo me-5" href="/Dashboard"><img src="assets/images/logo pdam.jpg" style="height: 45px; margin-left: 65px; margin-right: 30px;" alt="logo" /><h6 style="font-size: 12px; margin-left: 60px; margin-right: 30px;">Perumdam Tirta Kencana</h6></a>
    </div>
...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <a class="navbar-brand brand-logo me-5" href="/Dashboard">
      <img src="assets/images/logo pdam.jpg" style="height: 45px; margin-left: 65px; margin-right: 30px;" alt="logo" />
      <h6 style="font-size: 12px; margin-left: 60px; margin-right: 30px;">Perumdam Tirta Kencana</h6>
    </a>
  </div>
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">

    <!-- ✅ Tombol Toggle Sidebar (buka/tutup sidebar kiri) -->
